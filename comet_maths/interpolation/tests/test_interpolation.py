...
class TestInterpolation(unittest.TestCase):
    ...
    def test_interpolation_1d_along_example_unc(self):
        ...
        y_HR = cm.generate_sample(1, y_HR, u_y_HR, corr_x=corr_y_HR)[:, 0]
        ...
        y_hr_cubic2, u_y_hr_cubic2, corr_y_hr_cubic = cm.interpolate_1d_along_example(
            xi,
            yi,
            x_HR,
            y_HR,
        ...
        u_y_hr, xsamp, ysamp = mcprop.propagate_random(
            inp2.interpolate_1d_along_example,
            [xi, yi, x_HR, y_HR, xx],
            [None, u_yi, None, u_y_HR, None],
            corr_x=[None, "rand", None, corr_y_HR, None],return_samples=True
        )
