...
class TestInterpolation(unittest.TestCase):
    ...
    # def test_gaussian_progress_regression(self):
    #     np.random.seed(1234567)
    #
    #     xi = np.arange(0, 3.0, 0.25)
    #     yi = function2(xi)
    ...
    #
    #     xx = np.arange(0.1, 2.5, 0.02)
    #     y_gpr,u_y_gpr = cm.gaussian_progress_regression(
    #         xi,
    #         yi,
    #         xx,
    #         min_scale=0.3,
    ...
    #     )
    #
    #     y_gpr2,u_y_gpr2 = cm.gaussian_progress_regression(
    #         xi,
    #         yi,
    #         xx,
    ...
    #     )
    #
    #     y_gpr3,u_y_gpr3 = cm.gaussian_progress_regression(
    #         xi,
    #         yi,
    #         xx,
    #         u_y_i=np.arange(len(u_yi))*u_yi,
    ...
    #
    #
    #     y_hr_gpr,u_y_hr_gpr = cm.gaussian_progress_regression(
    #         x_HR,
    #         y_HR,
    #         xx,
    #         u_y_i=u_y_HR,
